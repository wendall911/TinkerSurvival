...
import tinkersurvival.world.block.BlockRock.EnumMineralType;
...
public class RockGenerator {
    ...
    private boolean generateRocks(World world, Random random, int i, int j, int k) {
                ...
                atBl.isOpaqueCube(atBl.getDefaultState()))
        {
            ...
            world.setBlockState(new BlockPos(i, j+1, k), TinkerSurvivalWorld.looseRock.getDefaultState().withProperty(TYPE,type));
        }
        return true;
    }
}
